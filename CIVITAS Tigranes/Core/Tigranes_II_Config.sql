...
VALUES	-- RISE AND FALL
		...
		'LOC_TRAIT_CIVILIZATION_CVS_ARMENIA_UA_XP1_DESCRIPTION', -- CivilizationAbilityDescription
		...
		'LOC_TRAIT_LEADER_CVS_TIGRANES_II_UA_XP1_DESCRIPTION', -- LeaderAbilityDescription
...
VALUES	-- RISE AND FALL
		('Players:Expansion1_Players',	'CIVILIZATION_CVS_ARMENIA',	'LEADER_CVS_TIGRANES_II',	'UNIT_CVS_ARMENIA_UU',		'ICON_UNIT_CVS_ARMENIA_UU',			'LOC_UNIT_CVS_ARMENIA_UU_NAME',			'LOC_UNIT_CVS_ARMENIA_UU_DESCRIPTION',		10			),
		('Players:Expansion1_Players',	'CIVILIZATION_CVS_ARMENIA',	'LEADER_CVS_TIGRANES_II',	'DISTRICT_CVS_ARMENIA_UI',	'ICON_DISTRICT_CVS_ARMENIA_UI',		'LOC_DISTRICT_CVS_ARMENIA_UI_NAME',		'LOC_DISTRICT_CVS_ARMENIA_UI_DESCRIPTION',	20			),
		-- GATHERING STORM
